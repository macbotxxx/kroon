...
class Upload_Products_Serializer (serializers.ModelSerializer):
    ...
    class Meta:
        model = Merchant_Product
        fields = ['product_sku', 'product_name', 'price', 'cost_price', 'stock', 'charge_by_weight','weight_quantity','weight_unit','out_of_stock_notify','low_stock_limit', 'category', 'products_variation', 'image', 'expire_notify', 'expiring_date',]
...
class Edit_Products_Serializer (serializers.ModelSerializer):
    ...
    class Meta:
        model = Merchant_Product
        fields = ['product_sku', 'product_name', 'price', 'cost_price', 'stock', 'charge_by_weight','weight_quantity','weight_unit','out_of_stock_notify','low_stock_limit', 'category', 'products_variation','expire_notify', 'expiring_date',]
...
class Product_Details_Serializers (serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'products_variation','product_sku','charge_by_weight','weight_quantity','weight_unit','out_of_stock_notify','low_stock_limit', 'product_name', 'slug', 'category', 'price','cost_price','image', 'stock','is_available','expire_notify', 'expiring_date','created_date', 'modified_date',]
