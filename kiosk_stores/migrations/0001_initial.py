# Generated by Django 3.2.9 on 2022-04-22 17:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_sku', models.CharField(help_text='Product sku should be added which identify each product', max_length=500, null=True, verbose_name='Product SKU')),
                ('product_name', models.CharField(help_text='Product name should be added which identify each product', max_length=500, null=True, verbose_name='Product Name')),
                ...
                ('stock', models.IntegerField(help_text='Total Product availablity for the current item , which will automatically be tagged as out of stock when it reduces to zero.', null=True, verbose_name='Total Stock')),
                ...
                ('user', models.ForeignKey(help_text='The user for whom account belongs to', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='merchant_products', to=settings.AUTH_USER_MODEL, verbose_name='User Profile')),
            ],
            options={
