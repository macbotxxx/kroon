    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, help_text='foreign key and session to the order table.', null=True, on_delete=django.db.models.deletion.CASCADE, to='kiosk_cart.order')),
                ('payment', models.ForeignKey(blank=True, help_text='foreign key and session to the payment table.', null=True, on_delete=django.db.models.deletion.CASCADE, to='kiosk_cart.payment')),
                ('product', models.ForeignKey(blank=True, help_text='foreign key and session to the product table.', null=True, on_delete=django.db.models.deletion.CASCADE, to='kiosk_stores.merchant_product')),
        ...
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(blank=True, help_text='Customers order payment information.', null=True, on_delete=django.db.models.deletion.CASCADE, to='kiosk_cart.payment'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kiosk_cart.cart')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kiosk_stores.merchant_product')),
                ('user', models.ForeignKey(help_text='The user for whom account belongs to', null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='User Profile')),
            ],
            options={
                'verbose_name': 'Merchant Cart',
                'verbose_name_plural': 'Merchant Cart',
                'ordering': ('-created_date',),
            },
        ),
    ]
